    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item nav-profile border-bottom">
            <a href="#" class="nav-link flex-column">
              <div class="nav-profile-image">
                <img src="../assets/images/sales_dp.png" alt="profile" />
                <!--change to offline or busy as needed-->
              </div>
              <div class="nav-profile-text d-flex ml-0 mb-3 flex-column">
                <span class="font-weight-semibold mb-1 mt-2 text-center">Sales Executive</span>
          ...
          <li class="nav-item">
            <a class="nav-link" onclick="loadViewCustomer()">
...
<script>
  function checkReverted() {
    ...
    xhttp.open("GET", "checkReverted", true);
    xhttp.send();
  }
</script>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" onclick="checkReverted()">Reverted</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="pages/ui-features/dropdowns.html">Approved</a>
                </li>
...
<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              ...
              <button class="btn btn-outline-primary bg-white mb-2 mb-md-0" onclick="window.location.href='/sales/exehome'"> Home </button>
    ...
    xhttp.send();
              ...
              <div class="header-right d-flex flex-wrap mt-2 mt-sm-0">
                ...
                <div id="customerFormContainer">
                  ...
                  <button type="button" class="btn btn-primary mt-2 mt-sm-0 btn-icon-text" onclick="loadCustomerForm()">
                    <i class="mdi mdi-plus-circle"></i> New Account
                </button>
  ...
  function loadCustomerForm() {
    ...
    xhttp.open("GET", "redirectaddcustomer", true);
    xhttp.send();
  }
</script>
              ...
              <div class="col-xl-9 stretch-card grid-margin">
                  ...
                  <div class="card-body" id="customersDetailsCardBody"> <!-- Add ID here -->
                    <div class="d-flex justify-content-between flex-wrap">
                     <div>
    <div class="card-title mb-0 stylish-heading"> Welcome to Your Sales Hub</div>
</div>
