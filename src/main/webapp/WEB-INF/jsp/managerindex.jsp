...
<html lang="en">
        ...
        <ul class="nav">
          <li class="nav-item nav-profile border-bottom">
            <a href="#" class="nav-link flex-column">
              <div class="nav-profile-image">
                <img src="../assets/images/manager_dp.png" alt="profile" />
                <!--change to offline or busy as needed-->
              </div>
              <div class="nav-profile-text d-flex ml-0 mb-3 flex-column">
                <span class="font-weight-semibold mb-1 mt-2 text-center">Manager</span>
          ...
          <li class="nav-item">
            <a class="nav-link" onclick="loadViewCustomer()">
              ...
              <span class="menu-title">Sales Compliance</span>
            </a>
  ...
  function loadViewCustomer() {
    ...
    xhttp.open("GET", "managerViewCustByStatus", true);
    xhttp.send();
  }
</script>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link btn btn-light" role="button" onclick="openedAcc()">Pending for closure</a>
                </li>
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              ...
              <button class="btn btn-outline-primary bg-white mb-2 mb-md-0" onclick="window.location.href='/manager/managerhome'"> Home </button>
              ...
              <div class="col-xl-9 stretch-card grid-margin">
                  ...
                  <div class="card-body" id="customersDetailsCardBody"> <!-- Add ID here -->
                    <div class="d-flex justify-content-between flex-wrap">
                     <div>
    <div class="card-title mb-0 stylish-heading"> Welcome to Your Hub</div>
</div>
